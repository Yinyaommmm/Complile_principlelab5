...
AS_operand* ast2llvmMemberExpr(aA_memberExpr e, bool inRight=false);
AS_operand* ast2llvmIdExpr(string id,bool fromLeft = false);
AS_operand* ast2llvmArrayExpr(aA_arrayExpr a, bool inRight = false);
