...
std::unordered_set<LLVMIR::L_block*> dom_union(std::unordered_set<LLVMIR::L_block*>& a,
                                  std::unordered_set<LLVMIR::L_block*>& b);

std::unordered_set<LLVMIR::L_block*> dom_intersection(std::unordered_set<LLVMIR::L_block*>& a,
                                         std::unordered_set<LLVMIR::L_block*>& b);
