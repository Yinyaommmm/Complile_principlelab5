...
bb7:                                              ; preds = %bb6
  ...
  %r122 = load i32, ptr %r119, align 4
  %r123 = getelementptr i32, ptr %r100, i32 %r122
  %r124 = load i32, ptr %r123, align 4
  %r125 = load i32, ptr %r104, align 4
  %r126 = getelementptr i32, ptr %r100, i32 %r125
  store i32 %r124, ptr %r126, align 4
  %r127 = load i32, ptr %r102, align 4
  %r128 = load i32, ptr %r103, align 4
  %r129 = getelementptr i32, ptr %r100, i32 %r128
  store i32 %r127, ptr %r129, align 4
