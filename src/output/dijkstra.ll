...
bb3:                                              ; preds = %bb2
  ...
  %r107 = getelementptr [16 x i32], ptr %r105, i32 0, i32 %r106
...
bb21:                                             ; preds = %bb18
  %r170 = load i32, ptr %r122, align 4
  %r171 = getelementptr [16 x i32], ptr @dis, i32 0, i32 %r170
  %r172 = load i32, ptr %r171, align 4
  %r173 = load i32, ptr %r122, align 4
  %r174 = getelementptr [16 x %array2D], ptr @e, i32 0, i32 %r173
  %r175 = getelementptr %array2D, ptr %r174, i32 0, i32 0
  %r176 = load i32, ptr %r144, align 4
  %r177 = getelementptr [16 x i32], ptr %r175, i32 0, i32 %r176
  %r178 = load i32, ptr %r177, align 4
  %r179 = add i32 %r172, %r178
  %r180 = load i32, ptr %r144, align 4
  %r181 = getelementptr [16 x i32], ptr @dis, i32 0, i32 %r180
...
bb32:                                             ; preds = %bb29
  ...
  %r205 = load i32, ptr %r186, align 4
  %r206 = getelementptr [16 x %array2D], ptr @e, i32 0, i32 %r205
  %r207 = getelementptr %array2D, ptr %r206, i32 0, i32 0
  %r208 = load i32, ptr %r192, align 4
  %r209 = getelementptr [16 x i32], ptr %r207, i32 0, i32 %r208
...
bb35:                                             ; preds = %bb34
  ...
  %r222 = load i32, ptr %r217, align 4
  %r223 = getelementptr [16 x %array2D], ptr @e, i32 0, i32 %r222
  %r224 = getelementptr %array2D, ptr %r223, i32 0, i32 0
  %r225 = load i32, ptr %r219, align 4
  %r226 = getelementptr [16 x i32], ptr %r224, i32 0, i32 %r225
