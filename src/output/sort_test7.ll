...
bb12:                                             ; preds = %bb9
  %r164 = load i32, ptr %r118, align 4
  %r165 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r164
  %r166 = load i32, ptr %r165, align 4
  %r167 = load i32, ptr %r148, align 4
  %r168 = getelementptr i32, ptr %r100, i32 %r167
  store i32 %r166, ptr %r168, align 4
...
bb13:                                             ; preds = %bb9
  %r173 = load i32, ptr %r119, align 4
  %r174 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r173
  %r175 = load i32, ptr %r174, align 4
  %r176 = load i32, ptr %r148, align 4
  %r177 = getelementptr i32, ptr %r100, i32 %r176
  store i32 %r175, ptr %r177, align 4
...
bb16:                                             ; preds = %bb15
  %r185 = load i32, ptr %r118, align 4
  %r186 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r185
  %r187 = load i32, ptr %r186, align 4
  %r188 = load i32, ptr %r148, align 4
  %r189 = getelementptr i32, ptr %r100, i32 %r188
  store i32 %r187, ptr %r189, align 4
...
bb19:                                             ; preds = %bb18
  %r197 = load i32, ptr %r119, align 4
  %r198 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r197
  %r199 = load i32, ptr %r198, align 4
  %r200 = load i32, ptr %r148, align 4
  %r201 = getelementptr i32, ptr %r100, i32 %r200
  store i32 %r199, ptr %r201, align 4
