...
bb16:                                             ; preds = %bb15
  ...
  %r162 = load i32, ptr %r112, align 4
  %r163 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r162
  %r164 = load i32, ptr %r163, align 4
  %r165 = load i32, ptr %r113, align 4
  %r166 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r165
  %r167 = load i32, ptr %r166, align 4
  %r168 = add i32 %r164, %r167
  %r169 = load i32, ptr %r111, align 4
  %r170 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r169
